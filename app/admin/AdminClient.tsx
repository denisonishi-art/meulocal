...
type Candidate={id:string;name:string;address:string;rating:number|null;reviews:number;website:string|null;score:number;priority:string;competitorAverageReviews?:number|null;competitionMode?:'local_radius'|'city_region'|'search_market';competitionLabel?:string|null;searchIntent?:string|null};
