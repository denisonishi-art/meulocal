import { ArrowRight, BarChart3, Check, MapPin, Search, Star, TrendingUp } from 'lucide-react';
  ...
  return (
    <main>
      <header className="nav container">
        ...
        <a className="navCta" href="#diagnostico">Quero aparecer mais <ArrowRight size={16}/></a>
      </header>
      ...
      <section id="top" className="hero container">
        ...
        <div className="heroActions">
          <a className="primary" href="#diagnostico">Ver minha oportunidade <ArrowRight size={18}/></a>
        ...
        <div className="dashboard" aria-label="Exemplo de evolução local">
          ...
          <div className="metrics">
            ...
            <div><small>Índice de Crescimento</small><strong>72 <span>→ 83</span></strong><b>+11 pts</b></div>
          </div>
        </div>
      </section>
      ...
      <section className="compare"><div className="container compareGrid"><div><div className="eyebrow light"><span></span>Inteligência local</div><h2>Você sabe como está comparado aos negócios que aparecem primeiro?</h2><p>Analisamos sua empresa contra os concorrentes que disputam os mesmos clientes na sua região.</p><ul><li><Check/>Diferença de avaliações</li><li><Check/>Posição no Google</li><li><Check/>Qualidade do site e SEO Local</li><li><Check/>Autoridade e oportunidades locais</li></ul></div><div className="score"><small>ÍNDICE DE OPORTUNIDADE LOCAL</small><div className="scoreValue">86<span>/100</span></div><div className="scoreBar"><i></i></div><strong>Potencial de melhoria: Alto</strong><p>Encontramos oportunidades claras para aumentar sua presença local.</p></div></div></section>

      <section id="diagnostico" className="cta container"><div className="ctaBox"><div><div className="eyebrow"><span></span>Comece por aqui</div><h2>Descubra onde sua empresa pode crescer no Google.</h2><p>Veja como você está em relação aos concorrentes da sua região e quais oportunidades merecem atenção primeiro.</p></div><a className="primary" href="mailto:contato@meulocal.com.br?subject=Quero%20minha%20análise%20local">Quero minha análise <ArrowRight size={18}/></a></div></section>
