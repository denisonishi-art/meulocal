export const meulocalBusinessRules = {
  ...
  systems: {
    ...
    paymentSystemBR: 'asaas',
    paymentSystemInternationalFuture: 'stripe',
    neverExposeHighLevelToCustomer: true,
    openseoIsInternalInfrastructure: true,
  },
  payments: {
    primaryProviderBR: 'asaas',
    useProviderAbstraction: true,
    monthlyPriceBRL: 397,
    acceptedCheckoutMethods: ['CREDIT_CARD','PIX'] as const,
    billingCycle: 'MONTHLY',
    webhookIsSourceOfTruth: true,
    successRedirectNeverConfirmsPayment: true,
    requireAuthenticatedWebhook: true,
    requireIdempotentWebhookProcessing: true,
    activateCustomerOnlyAfterConfirmedPayment: true,
  },
  seo: {
    provider: 'openseo',
  ...
  onboarding: {
    ...
    reviewActivation: {
      ...
      prioritizeRecentCustomersWhenPurchaseDateExists: true,
      fallbackToImportOrderWhenPurchaseDateMissing: true,
      stopImmediatelyOnOptOut: true,
      requireExplicitActivationConfirmation: true,
      neverTreatUploadAsPermissionToSend: true,
    },
  },
  advisor: {
